<%-- 
    Document   : about
    Created on : Apr 23, 2013, 7:05:59 PM
    Author     : Darshan
--%>
        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                <p><table width="100%" border="0">
                        <tr>
                            <th align="left" scope="row" colspan="3" style="font-family: cursive; font-size: x-large; text-align: center">Mini Project (2CE607)</th>
                            <td rowspan="3" width="25%"><img src="css/images/logo.jpg" width="300" height="150" alt="logo" align="right" /></td>
                        </tr>
                        <tr>
                            <th><h1>Calendar and Event Management</h1></th>
                        </tr>
                        <tr>
                            <th>B.Tech Semester VI Computer Engineering May-June 2013</th>
                        </tr>
                    </table>
                    <br>
                        ...
                        <tr><td>Technology</td>
                            <td>:</td>
                            <td>Java Web (JSP & Servlets)</td></tr>
                        <tr><td>Database</td>
                            <td>:</td>
                            <td>MySQL</td></tr>
                        <tr><td>Designing</td>
                            ...
                            <tr><th colspan="3" style="font-size: small;">Click <a href="css/final_college.pdf">here</a> to download project report</th></tr>
                    </table>
                </p>
            </div>
            <div id="tabs-2">
                <div><table width="100%" border="0" cellspacing="5" cellpadding="5">
                        <tr>
                            ...
                            <td rowspan="4"><img src="css/images/DSCN0010~1.jpg" width="150" height="150" alt="darshan" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td rowspan="4"><img src="css/images/3b85150.jpg" width="150" height="150" alt="dhruvi" /></td>
                        </tr>
                        <tr>
                    ...
                    <form action="about" method="post">
                        <table border="0">
                            <tr>
                                <td>Name</td>
                                <td>:</td>
                                <td><input size="49" type="text" value="${fname} ${lname}" name="name" required/></td>
                            </tr>
                            <tr>
                                <td>Email ID</td>
                                <td>:</td>
                                <td><input size="49" type="text" value="${email}" name="email" readonly required style="background-color: threedlightshadow"/></td>
                            </tr>
                            <tr>
                                <td>Mobile No.</td>
                                <td>:</td>
